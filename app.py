...
with st.sidebar:
    ...
    # Add transcript formatting option
    format_transcript = st.checkbox("Improve Transcript Formatting", 
                                   value=False,
                                   help="Add paragraph breaks and improve dialogue formatting")
    
    # Store in session state
    st.session_state.format_transcript = format_transcript
...
if youtube_url and is_valid_media_url(youtube_url):
    try:
...
has_yt_url = youtube_url and is_valid_media_url(youtube_url)
            ...
            if has_yt_url:
                ...
                if transcript_exists(youtube_url, OUTPUT_DIR):
                    ...
                    transcript, transcript_path = process_video_transcribe(
                        ...
                        # Remove the format_transcript parameter
                    )
                    st.session_state.transcript = transcript
                    # Store results
                    result = {
